...
def _build_sam(
    ...
    sam = Sam(
        ...
        # frefuse=FreqFusion(hr_channels=256, lr_channels=256),
        # pvt=pvt_v2_b2(),
        DWT=extract_high_frequency(),
        ME=ME(256*2, 256),
        routefuse=routefuse(256, 16),
        # ME=ME(128),
        # Loop_finer=Loop_Finer(260, 64, 32),
        # BC=bias_correction(512),
        # Unet=UNet(n_channels=256, n_classes=256, bilinear=None),
